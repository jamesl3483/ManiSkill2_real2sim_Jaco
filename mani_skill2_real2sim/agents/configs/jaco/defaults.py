...
class JacoDefaultConfig:
    def __init__(self) -> None:
        self.urdf_path = (
            # "{PACKAGE_ASSET_DIR}/descriptions/jaco_description/j2n6s300.urdf"
            "{PACKAGE_ASSET_DIR}/descriptions/jaco_description/j2s7s300_gym.urdf"
        )
        self.robot_name = "j2s7s300"
        ...
        self.arm_joint_names = [
            f'{self.robot_name}_joint_1', 
            f'{self.robot_name}_joint_2', 
            f'{self.robot_name}_joint_3', 
            f'{self.robot_name}_joint_4', 
            f'{self.robot_name}_joint_5', 
            f'{self.robot_name}_joint_6',
            f'{self.robot_name}_joint_7'
        ]
        self.gripper_joint_names = [
            f'{self.robot_name}_joint_finger_1', 
            f'{self.robot_name}_joint_finger_2', 
            f'{self.robot_name}_joint_finger_3'
        ]
        ...
        # Apparently online it says that the control frequency is 100Hz,
        # but we shall see through testing 
        ...
        # self.arm_stiffness = [600, 365, 400, 600, 640, 530]
        # self.arm_damping = [500, 270, 230, 460, 300, 400]
        self.arm_damping = [500, 570, 530, 460, 300, 300, 400]

        # self.arm_stiffness = [10.0] * 6
        # self.arm_damping = [10.0] * 6
        ...
        self.arm_force_limit = [200, 200, 100, 100, 100, 100, 100]
        ...
        self.ee_link_name = f"{self.robot_name}_end_effector"
...
class JacoBridgeDatasetCameraSetupConfig(JacoDefaultConfig):
    @property
    def cameras(self):
        return [
            CameraConfig(
...
class JacoSinkCameraSetupConfig(JacoDefaultConfig):
    @property
    def cameras(self):
        return [
            CameraConfig(
                ...
                actor_uid=f"{self.robot_name}_link_base",
                width=640,
                height=480,
